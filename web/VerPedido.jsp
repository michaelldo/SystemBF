                                ...
                                <div class="box-body">
                                    <table class="table table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                <td colspan="6" style="text-align: center;"><H3>DETALHES DO PEDIDO</H3></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td colspan="2"><b>CÓDIDO DO PEDIDO:</b> ${ped.idPedido}</td>
                                                <td colspan="4"><b>CLIENTE:</b> ${ped.cliente.nome}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><b>DATA:</b> <fmt:formatDate value="${ped.dataHora}" pattern="dd/MM/yyyy"/></td>
                                                <td colspan="3"><b>HORA:</b> <fmt:formatDate value="${ped.dataHora}" pattern="HH:mm:ss"/></td></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"><b>OBSERVAÇÃO:</b></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">${ped.observacao}</td>
                                            </tr>
                                            <tr>
                                                <th>COD PRODUTO</th>
                                                <th>DESCRIÇÃO</th>
                                            ...
                                            <c:forEach var="pro" items="${ped.produtos}">
                                                <tr>
